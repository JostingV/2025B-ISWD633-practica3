...
```
C:\Users\Josti>docker run -d --name server-postgres -e POSTGRES_DB=db_drupal -e POSTGRES_PASSWORD=12345 -e POSTGRES_USER=user_drupal -v vol-postgres:/var/lib/postgresql/data --network net-drupal postgres
...
```
C:\Users\Josti>docker run -d --name client-postgres --publish published=9500,target=80 -e PGADMIN_DEFAULT_PASSWORD=54321 -e PGADMIN_DEFAULT_EMAIL=jostingxavier7@gmail.com --network net-drupal dpage/pgadmin4
...
C:\Users\Josti>docker run -d --name server-drupal --publish published=9700,target=80 -v vol-drupal-sites:/var/www/html/sites -v vol-drupal-modules:/var/www/html/modules -v vol-drupal-themes:/var/www/html/themes --network net-drupal drupal

### Ingrese al server-drupal y siga el paso a paso para la instalación.
<img width="1919" height="976" alt="image" src="https://github.com/user-attachments/assets/3cdd42ff-3705-4e7c-b80a-a6bd946ffb67" />
<img width="1919" height="978" alt="image" src="https://github.com/user-attachments/assets/ed65471a-4d9b-4289-92eb-1f1905e0fb0c" />
<img width="1919" height="1028" alt="image" src="https://github.com/user-attachments/assets/92ab2763-9f3b-45e4-bae9-17b9fb651f1a" />


_La instalación puede tomar varios minutos, mientras espera realice un diagrama de los contenedores que ha creado en este apartado._

<img width="2431" height="1230" alt="image" src="https://github.com/user-attachments/assets/656611f0-84d2-4b56-a76b-6a8764a8d13a" />
